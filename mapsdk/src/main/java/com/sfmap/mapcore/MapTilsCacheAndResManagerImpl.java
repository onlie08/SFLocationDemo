...
public class MapTilsCacheAndResManagerImpl extends MapTilsCacheAndResManager
{
  ...
  {
    return ResUtil.decodeAssetResData(this.mContext, Util.MAP_MAP_ASSETS_NAME+"/" + paramString);
  }
  ...
  private void initRelease()
  {
    ...
    File localFile1 = new File(Util.getMapRoot(this.mContext));
    if (!localFile1.exists()) {
      localFile1.mkdir();
    }
    File localFile2 = new File(localFile1, Util.MAP_DATA_PATH);
    if (!localFile2.exists()) {
      localFile2.mkdir();
    }
    this.mMapBaseDataPath = (localFile2.toString() + "/");

    File localFile3 = new File(localFile2, Util.MAP_DATA_OFFLINE_PATH_NAME);
    if (!localFile3.exists()) {
      localFile3.mkdir();
    }
    this.mMapOfflinePath = (localFile3.toString() + "/");

    File localFile4 = new File(localFile2, Util.MAP_CACHE_PATH_NAME);
    ...
    i = 0;
    File localFile5 = new File(localFile4, Util.MAP_TILES_PATH_NAME);
    ...
    i = 0;
    File localFile6 = new File(localFile4, Util.MAP_RES_EXT_PATH_NAME);
  ...
  public void saveFile(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    String ssssssa = paramString + "" + "0" + paramInt1 + "" + paramInt2 + ".data";
...
//                  index += 4;
    ...
    return ResUtil.decodeAssetResData(this.mContext,Util.MAP_MAP_ASSETS_NAME+"/"+ styleFileName);
  }
