...
public abstract class AsyncTaskDecode<Params, Progress, Result> //av
{
  ...
  public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(2, 16, 5L, TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory, new ThreadPoolExecutor.DiscardOldestPolicy()); //b
  ...
  public static final Executor DUAL_THREAD_EXECUTOR = Executors.newFixedThreadPool(2, sThreadFactory); // d
  private static final InternalHandler sHandler = new InternalHandler(); 
  private static volatile Executor sDefaultExecutor = THREAD_POOL_EXECUTOR; //g
