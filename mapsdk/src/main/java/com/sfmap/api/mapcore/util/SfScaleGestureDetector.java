...
/**
 * Created by caohai on 2018/7/6.
 */
public class SfScaleGestureDetector {
    private static final String TAG = "SfScaleGestureDetector";

    public interface OnScaleGestureListener {
        public boolean onScale(SfScaleGestureDetector detector);

        public boolean onScaleBegin(SfScaleGestureDetector detector);

        public void onScaleEnd(SfScaleGestureDetector detector);
    }
...
//                    new InputEventConsistencyVerifier(this, 0) : null;
    ...
    public SfScaleGestureDetector(Context context, OnScaleGestureListener listener) {
    ...
    public SfScaleGestureDetector(Context context, OnScaleGestureListener listener,
        ...
        mMinSpan = 20;
        android.util.Log.i("caohai","mMinSpan"+mMinSpan +"mTouchMinMajor"+mTouchMinMajor);
        mHandler = handler;
