  ...
  implements IMarkerDelegate
{
  ...
  private MapOverlayImageViewDecode mapOverlay;
  ...
  public MarkerDelegateImp(MarkerOptions options, MapOverlayImageViewDecode mapOverlay)
  {
  ...
  public Rect getRect()
  {
    ...
    try
    {
      MapProjection localMapProjection = this.mapOverlay.map.getMapProjection();
      int i1 = getIconWidth();
  ...
  {
    if (this.mapOverlay.map != null) {
      this.mapOverlay.map.setRunLowFrame(false);
    }
  }
  ...
  public LatLng getPosition()
  {
    if ((this.isPixePoint) && (this.glPoint != null))
    {
      ...
      calFPoint();
      this.mapOverlay.map.a(this.glPoint.x, this.glPoint.y, localIPoint);
  ...
  {
    if (this.isPixePoint) {
      this.mapOverlay.map.getMapProjection().win2Map(this.xPixel, this.yPixel, this.glPoint);
    } else {
      this.mapOverlay.map.getMapProjection().geo2Map(this.x, this.y, this.glPoint);
    }
    return true;
  }
    ...
    if (!this.initTexture) {
      try
      {
        if (this.icons != null)
        {
          ...
          {
            if (i4 != 0) {
              textureid = this.mapOverlay.a(bitmapDes);
            }
            if (textureid == 0)
            {
              ...
              if ((bitmap != null) && (!bitmap.isRecycled()))
              {
                ...
                if (i4 != 0) {
                  this.mapOverlay.a(new OverlayTextureItem(bitmapDes, textureid));
                }
  ...
  {
    int texsureId = this.mapOverlay.map.getTexsureId();
    if (texsureId == 0)
    {
      int[] arrayOfInt = { 0 };
  ...
  public LatLng g()
  {
    if (this.isPixePoint)
    {
      ...
      DPoint localDPoint = new DPoint();
      this.mapOverlay.map.getPixel2LatLng(this.xPixel, this.yPixel, localDPoint);
  ...
  public void setPositionByPixels(int x, int y)//a
  {
    ...
    try
    {
      this.pointFloatArray = Util.makeFloatArray(this.mapOverlay.map, this.flat ? 1 : 0, this.glPoint, this.e, getIconWidth(), getIconHeight(), this.anchorU, this.anchorV);
    }
    catch (Throwable localThrowable)
    {
  ...
  {
    Rect localRect = this.mapOverlay.map.getRect();
    if ((this.isPixePoint) || (localRect == null)) {
      return true;
    }
    IPoint localIPoint = new IPoint();
    if ((this.isPerspective) && (this.v != null)) {
      this.mapOverlay.map.getLatLng2Pixel(this.v.latitude, this.v.longitude, localIPoint);
    } else if (this.lonlatPoint != null) {
      this.mapOverlay.map.getLatLng2Pixel(this.lonlatPoint.latitude, this.lonlatPoint.longitude, localIPoint);
    }
  ...
  public IPoint getGeoPoint()
  {
    ...
    if (this.isPixePoint)
    {
      this.mapOverlay.map.getPixel2Geo(this.xPixel, this.yPixel, localIPoint);
      return localIPoint;
    }
