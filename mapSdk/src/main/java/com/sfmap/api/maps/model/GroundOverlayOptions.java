  ...
  implements Parcelable
{
  ...
  {
    MapThrowException.ThrowIllegalStateException(this.bounds == null, "Position has already been set using positionFromBounds");
    MapThrowException.bThrowIllegalArgumentException(location != null, "Location must be specified");
    MapThrowException.bThrowIllegalArgumentException(width >= 0.0F, "Width must be non-negative");
  ...
  public GroundOverlayOptions position(LatLng location, float width, float height)
  {
    ...
    MapThrowException.bThrowIllegalArgumentException(location != null, "Location must be specified");
    MapThrowException.bThrowIllegalArgumentException(width >= 0.0F, "Width must be non-negative");
    MapThrowException.bThrowIllegalArgumentException(height >= 0.0F, "Height must be non-negative");
  ...
  {
    MapThrowException.ThrowIllegalStateException(this.location == null, "Position has already been set using position: " + this.location);
  ...
  {
    MapThrowException.bThrowIllegalArgumentException((transparency >= 0.0F) && (transparency <= 1.0F), "Transparency must be in the range [0..1]");
    this.transparency = transparency;
    return this;
  }
