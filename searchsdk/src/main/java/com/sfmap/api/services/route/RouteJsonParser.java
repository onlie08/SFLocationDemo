...
//        }
    ...
    private RouteBusWalkItem parseWalkItem(JSONObject stepObj)throws JSONException{
        ...
        if(stepObj.has("vehicle")){
            ...
            walkItem.setStartName(BusSearchServerHandler.getJsonStringValue(object, "start_name", ""));
            walkItem.setEndName(BusSearchServerHandler.getJsonStringValue(object, "end_name", ""));
        }
