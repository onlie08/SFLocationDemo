...
public class SfMapLocation extends Location {
    ...
    /**
     *定位错误码：一些重要参数为空,如context,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    ...
    /**
     *定位错误码：获取到的请求参数为空，可能获取过程中出现异常,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    public static final int ERROR_CODE_FAILURE_LOCATION_PARAMETER = 3;
    /**
     *定位错误码：网络连接异常,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    public static final int ERROR_CODE_FAILURE_CONNECTION = 4;
    /**
     *定位错误码：解析XML出错,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    public static final int ERROR_CODE_FAILURE_PARSER = 5;
    /**
     *定位错误码：定位结果错误,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    public static final int ERROR_CODE_FAILURE_LOCATION = 6;
    /**
     *定位错误码：KEY错误,可以通过SfMapLocation.getLocationDetail()获取详细信息来跟注册的KEY信息进行对照
     */
    public static final int ERROR_CODE_FAILURE_AUTH = 7;
    /**
     *定位错误码：其他错误,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
    public static final int ERROR_CODE_UNKNOWN = 8;
    /**
     *定位错误码：初始化异常,可以通过SfMapLocation.getLocationDetail()获取详细信息
     */
