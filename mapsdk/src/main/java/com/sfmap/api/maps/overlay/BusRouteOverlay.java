...
import com.sfmap.api.services.route.RouteBusWalkItem;
  ...
  extends RouteOverlay
{
  ...
  private LatLng latLng;
     ...
     * @param map  - 地图对象。
     * @param path  - 公交路径规划的一个路段。详见搜索服务模块的路径查询包（com.sfmap.api.services.route）中的类 {@link BusPath}。
     * @param start - 起点坐标。详见搜索服务模块的核心基础包（com.sfmap.api.services.core）中的类 {@link LatLonPoint}。
     * @param end - 终点坐标。详见搜索服务模块的核心基础包（com.sfmap.api.services.core）中的类 {@link LatLonPoint}。
     */
