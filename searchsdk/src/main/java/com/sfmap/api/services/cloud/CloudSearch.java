...
public class CloudSearch {
     ...
     *                        异常信息。
     */
    CloudSearchResult searchData() throws SearchException {
    ...
    public static class Query {
        ...
        /**
         * 过滤条件（and name ='7' and name like'%7%' order by id desc）。
         */
         ...
         *                 数据集的唯一标识,必填。
         * @param filter
         *              过滤条件(and name ='7' and name like'%7%' order by id desc)选填。
         * @param bBox
         *            bbox（逗号分隔的一对经纬度代表一个坐标，用分号分割多个坐标）,必填。
         */
