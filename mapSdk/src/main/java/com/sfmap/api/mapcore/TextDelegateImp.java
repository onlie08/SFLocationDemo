  ...
  implements ITextDelegate
{
  ...
  public void destroy()
  {
    ...
    {
      this.B = true;
      if ((this.mapOverlay != null) && (this.mapOverlay.map != null)) {
  ...
  public TextDelegateImp(TextOptions options, MapOverlayImageViewDecode viewDecode)
  ...
  public boolean calFPoint()
  {
    ...
    this.mapOverlay.map.getLatLng2Map(this.position.latitude, this.position.longitude, this.glPoint);
  ...
  private void a(IMapDelegate mapDelegate)
    throws RemoteException
  {
    float[] arrayOfFloat = com.sfmap.api.mapcore.util.Util.makeFloatArray(mapDelegate, 0, this.glPoint, this.rotate, this.bitmap
      .getWidth(), this.bitmap.getHeight(), this.anchorU, this.anchorV);
    if (this.floatBuffer == null) {
      this.floatBuffer = com.sfmap.api.mapcore.util.Util.makeFloatBuffer(arrayOfFloat);
    } else {
      this.floatBuffer = com.sfmap.api.mapcore.util.Util.makeFloatBuffer(arrayOfFloat, this.floatBuffer);
    }
    arrayOfFloat = null;
    if (this.textureId != 0) {
    ...
    if (!this.C) {
      try
      {
        if ((this.bitmap != null) && (!this.bitmap.isRecycled()))
        {
          ...
          com.sfmap.api.mapcore.util.Util.bindTexture(gl, this.textureId, this.bitmap, false);
          this.C = true;
          this.bitmap.recycle();
        }
      }
  ...
  {
    LatLngBounds localLatLngBounds = this.mapOverlay.map.getMapBounds();
