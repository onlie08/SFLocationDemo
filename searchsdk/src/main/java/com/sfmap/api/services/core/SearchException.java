...
public class SearchException extends Exception {
    ...
    public static final String ERROR_CLOUD_1 = "已存在相同名称的数据集";//3001
    public static final String ERROR_CLOUD_2 = "数据集不可操作";//2002
    public static final String ERROR_CLOUD_3 = "坐标格式错误";//400
    public static final String ERROR_CLOUD_4 = "data里的自定义字段不存在";//4003
    public static final String ERROR_CLOUD_5 = "系统异常";//500
    public static final String ERROR_CLOUD_6 = "data格式错误";//4001
    public static final String ERROR_CLOUD_7 = "参数错误";//2
    public static final String ERROR_CLOUD_8 = "数据ID不存在";//5001
    public static final String ERROR_CLOUD_9 = "数据集不存在";//2001
    public static final String ERROR_CLOUD_10 = "ids有数据ID不存在\"";//5002
    public static final String ERROR_CLOUD_11 = "删除数据（单条/批量）失败";//2
    public static final String ERROR_CLOUD_12 = "服务器内部错误";//500
    ...
    public static final int ERROR_CODE_CLOUD_2=2;
    public static final int ERROR_CODE_CLOUD_2001=2001;
    public static final int ERROR_CODE_CLOUD_2002=2002;
    public static final int ERROR_CODE_CLOUD_3001=3002;
    public static final int ERROR_CODE_CLOUD_400=400;
    public static final int ERROR_CODE_CLOUD_4001=4001;
    public static final int ERROR_CODE_CLOUD_4003=4003;
    public static final int ERROR_CODE_CLOUD_500=500;
    public static final int ERROR_CODE_CLOUD_5001=5001;
    public static final int ERROR_CODE_CLOUD_5002=5002;
	...
	private void initErrorMessageCode(String errorMessage) {
        ...
        else if(errorMessage.contains(ERROR_CLOUD_1)){
            errorCode=ERROR_CODE_CLOUD_3001;
                }
        else if(errorMessage.contains(ERROR_CLOUD_2)){
            errorCode=ERROR_CODE_CLOUD_2002;
                }
        else if(errorMessage.contains(ERROR_CLOUD_3)){
            errorCode=ERROR_CODE_CLOUD_400;
                }
        else if(errorMessage.contains(ERROR_CLOUD_4)){
            errorCode=ERROR_CODE_CLOUD_4003;
                }
        else if(errorMessage.contains(ERROR_CLOUD_5)||errorMessage.contains(ERROR_CLOUD_12)){
            errorCode=ERROR_CODE_CLOUD_500;
                }
        else if(errorMessage.contains(ERROR_CLOUD_6)){
            errorCode=ERROR_CODE_CLOUD_4001;
                }
        else if(errorMessage.contains(ERROR_CLOUD_7)||errorMessage.contains(ERROR_CLOUD_11)){
            errorCode=ERROR_CODE_CLOUD_2;
                }
        else if(errorMessage.contains(ERROR_CLOUD_8)){
            errorCode=ERROR_CODE_CLOUD_5001;
                }
        else if(errorMessage.contains(ERROR_CLOUD_9)){
            errorCode=ERROR_CODE_CLOUD_2001;
                }
        else if(errorMessage.contains(ERROR_CLOUD_10)){
            errorCode=ERROR_CODE_CLOUD_5002;
                }
