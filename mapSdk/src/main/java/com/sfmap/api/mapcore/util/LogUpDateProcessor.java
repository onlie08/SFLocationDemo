...
abstract class LogUpDateProcessor
{
  ...
  protected LogUpDateProcessor(Context context)
  {
    ...
    {
      SDKLogHandler.exception(localThrowable, "LogProcessor", "LogUpDateProcessor");
  ...
  void processUpdateLog(Context context)
  {
    ...
    {
      SDKLogHandler.exception(throwable, "LogProcessor", "processUpdateLog");
  ...
  private void processDelete(LogDBOperation dbOperation, int paramInt)
  {
    ...
    {
      SDKLogHandler.exception(localThrowable, "LogProcessor", "processDeleteFail");
  ...
  private int processUpdate(Context context,String logStr)
  {
    ...
    try
    {
      ...
      {
        SDKLogHandler.exception(e, "LogProcessor", "processUpdate");
    ...
    {
      SDKLogHandler.exception(localbl, "LogProcessor", "processUpdate");
  ...
  private String getPublicInfo(Context context)
  {
    ...
    {
      SDKLogHandler.exception(e, "LogProcessor", "getPublicInfo");
      e.printStackTrace();
    }
    catch (Throwable throwable)
    {
      SDKLogHandler.exception(throwable, "LogProcessor", "getPublicInfo");
      throwable.printStackTrace();
    }
    return str1;
  }
...
//        loginfo = loginfo + "||" + logInfo.d();
  ...
  private String readLog(String md5)
  {
    ...
    {
      SDKLogHandler.exception(ioex, "LogProcessor", "readLog");
      ioex.printStackTrace();
    }
    catch (Throwable throwable)
    {
      SDKLogHandler.exception(throwable, "LogProcessor", "readLog");
      throwable.printStackTrace();
    }
    finally
    {
      if (byteoutputstream != null) {
        ...
        {
          SDKLogHandler.exception(e, "LogProcessor", "readLog1");
      ...
      if (inputStream != null) {
        ...
        {
          SDKLogHandler.exception(localIOException13, "LogProcessor", "readLog2");
  ...
  void closeDiskLru()
  {
    if ((this.cache != null) && (!this.cache.isClosed())) {
      ...
      {
        SDKLogHandler.exception(localIOException, "LogProcessor", "closeDiskLru");
        localIOException.printStackTrace();
      }
      catch (Throwable localThrowable)
      {
        SDKLogHandler.exception(localThrowable, "LogProcessor", "closeDiskLru");
        localThrowable.printStackTrace();
      }
    }
  }
  ...
  private DiskLruCache initDiskLru(Context context, String paramString)
  {
    ...
    {
      SDKLogHandler.exception(localIOException, "LogProcessor", "initDiskLru");
      localIOException.printStackTrace();
    }
    catch (Throwable localThrowable)
    {
      SDKLogHandler.exception(localThrowable, "LogProcessor", "initDiskLru");
      localThrowable.printStackTrace();
    }
    return localde;
  }
