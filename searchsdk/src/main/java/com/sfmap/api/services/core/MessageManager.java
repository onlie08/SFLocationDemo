...
public class MessageManager extends Handler {
	...
	private void handleCloudStorageDelSetMessage(Message paramMessage) {
		...
		if(result==null){
			listener.onDelSet(0,paramMessage.arg2);
			return;
		}
		listener.onDelSet(result.getDatasetId(),paramMessage.arg2);
	}
	...
	private void handleCloudStorageDelMessage(Message paramMessage) {
		...
		result = ((CloudStorageWrapper) localObject).result;
		if(result==null){
			listener.onDel(0,new int[]{},paramMessage.arg2);
			return;
		}
		listener.onDel(result.getDatasetId(),result.getId(),paramMessage.arg2);
	}
	...
	private void handleCloudStorageUpdataMessage(Message paramMessage) {
		...
		result = ((CloudStorageWrapper) localObject).result;
		if(result==null){
			listener.onUpdata(0,new int[]{},paramMessage.arg2);
			return;
		}
		listener.onUpdata(result.getDatasetId(),result.getId(),paramMessage.arg2);
	}
	...
	private void handleCloudStorageAddSetMessage(Message paramMessage) {
		...
		listener.onAddSet(result.getDatasetId(),paramMessage.arg2);
	}
	...
	private void handleCloudStorageAddMessage(Message paramMessage) {
		...
		result = ((CloudStorageWrapper) localObject).result;
		if(result==null){
			listener.onAdd(0,new int[]{},paramMessage.arg2);
			return;
		}
		listener.onAdd(result.getDatasetId(),result.getId(),paramMessage.arg2);
	}
	...
	private void HandlePOIIDSearchMessage(Message paramMessage) {
        ...
        localOnPoiSearchListener.onPoiItemSearched((List<PoiItem>) localObject2,  paramMessage.arg2);
	}
    ...
    private void HandlePOISearchMessage(Message paramMessage) {
        ...
        localOnPoiSearchListener.onPoiSearched((PoiResult) localObject2,
                paramMessage.arg2);
    }
