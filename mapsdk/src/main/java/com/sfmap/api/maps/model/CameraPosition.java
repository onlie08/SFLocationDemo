  ...
  implements Parcelable
{
  ...
  {
    MapThrowException.ThrowNullPointerException(target, "CameraPosition 位置不能为null ");
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return this.target.equals(localCameraPosition.target) &&
            Float.floatToIntBits(this.zoom) == Float.floatToIntBits(localCameraPosition.zoom) &&
            Float.floatToIntBits(this.tilt) == Float.floatToIntBits(localCameraPosition.tilt) &&
            Float.floatToIntBits(this.bearing) == Float.floatToIntBits(localCameraPosition.bearing);
  }
  
  public String toString()
  {
    return Util.joint(new String[] { Util.a("target", this.target),
  ...
  public static final class Builder
  {
    ...
    {
      MapThrowException.ThrowNullPointerException(this.location);
