  ...
  implements IPolygonDelegate
{
  ...
  public PolygonDelegateImpDecode(IMapDelegate paramaa)
  {
    ...
    {
      SDKLogHandler.exception(localRemoteException, "PolygonDelegateImp", "create");
  ...
  public void destroy()
  {
    ...
    {
      SDKLogHandler.exception(localThrowable, "PolygonDelegateImp", "destroy");
    ...
    throws RemoteException
  {
    ...
    {
      SDKLogHandler.exception(localThrowable, "PolygonDelegateImp", "contains");
      localThrowable.printStackTrace();
    }
    return false;
  }
