...
public class MapCore
{
  ...
  public MapCore(Context paramContext)
  {
    ...
    AppInfo.setContext(paramContext);
  }
  ...
  public void newMap()
  {
    ...
    String rootPath = Util.getMapRoot(this.mContext);
  ...
  private static native void nativeTile2QuadKey(Tile tile, String quadKey, int projType);
