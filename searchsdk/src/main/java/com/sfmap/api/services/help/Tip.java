...
public class Tip implements android.os.Parcelable {
	...
	public Tip(Parcel paramParcel) {
		...
		this.exttype = paramParcel.readString();
		this.extinfo = paramParcel.readString();
		this.deepinfos = paramParcel.readString();
	}
	...
	public void writeToParcel(Parcel paramParcel, int flags) {
        ...
        paramParcel.writeString(this.exttype);
        paramParcel.writeString(this.deepinfos);
	}
	...
	public void setDeepinfos(String deepinfos) {
		this.deepinfos = deepinfos;
	}
	...
	public String toString() {
		return "Tip [poiID=" + poiID + ", name=" + name + ", point=" + point
				...
				+ ", exttype="+ exttype+ ", extinfo="+ extinfo+ ", deepinfos="+ deepinfos +"]";
	}
