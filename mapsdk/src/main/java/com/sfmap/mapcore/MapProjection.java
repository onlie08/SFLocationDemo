...
//    Log.e("setGeoCenter","x:"+x+",y:"+y);
  ...
  {
    if( AppInfo.currentZoom != paramFloat) {
      nativeSetMapZoomer(this.native_instance, paramFloat);
      AppInfo.currentZoom = paramFloat;
//      Log.i("caohai", "zoom:" + paramFloat + " time:" + System.currentTimeMillis());
    }else {
//      Log.i("caohai", "重复请求" + System.currentTimeMillis());
    }
  }
