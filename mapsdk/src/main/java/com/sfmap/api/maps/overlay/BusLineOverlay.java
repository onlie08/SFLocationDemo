...
public class BusLineOverlay
{
  ...
  private Context context;
     ...
     * @param lmap  - 地图对象。
     * @param busLineItem - 公交线路。详见搜索服务模块的公交线路和公交站点包（com.sfmap.api.services.busline）中的类 {@link BusStationItem}。
     */
  ...
  public int getBusStationIndex(Marker marker)
  {
     ...
     * 返回第index的公交站点的信息。
     * @param index  - 第几个公交站点。
     * @return 公交站点的信息。详见搜索服务模块的公交线路和公交站点包（com.sfmap.api.services.busline）中的类 {@link BusStationItem}。
     */
