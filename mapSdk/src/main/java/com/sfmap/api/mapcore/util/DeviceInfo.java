...
public class DeviceInfo //bq
{
  ...
  public static String getUTDID(Context paramContext)
  {
    try
    {
      ...
      if (paramContext.checkCallingOrSelfPermission("android.permission.WRITE_SETTINGS") == PackageManager.PERMISSION_GRANTED) {
  ...
  static String g(Context context)
  {
    ...
    try
    {
      if ((context == null) || (context.checkCallingOrSelfPermission("android.permission.ACCESS_WIFI_STATE") != PackageManager.PERMISSION_GRANTED)) {
        return str;
      }
  ...
  static String getDeviceMac(Context paramContext)
  {
    try
    {
      ...
      if (paramContext.checkCallingOrSelfPermission("android.permission.ACCESS_WIFI_STATE") != PackageManager.PERMISSION_GRANTED) {
        return c;
      }
      WifiManager localWifiManager = (WifiManager)paramContext.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
  ...
  static String[] cellInfo(Context paramContext)
  {
    try
    {
      if ((paramContext.checkCallingOrSelfPermission("android.permission.READ_PHONE_STATE") != PackageManager.PERMISSION_GRANTED)
              || (paramContext.checkCallingOrSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != PackageManager.PERMISSION_GRANTED)) {
        return new String[] { "", "" };
      }
  ...
  {
    int i = -1;
    if ((context == null) || (context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") != PackageManager.PERMISSION_GRANTED)) {
      return i;
    }
    ConnectivityManager connectivityManager = (ConnectivityManager)context.getSystemService(Context.CONNECTIVITY_SERVICE);
    if (connectivityManager == null) {
