...
public class PoiItem implements android.os.Parcelable {
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeString(this.exttype);
		dest.writeString(this.extinfo);
		dest.writeString(this.deepinfos);
	}
	...
	protected PoiItem(Parcel in) {
		...
		this.location = in.readParcelable(LatLonPoint.class.getClassLoader());
