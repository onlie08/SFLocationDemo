  ...
  implements Parcelable
{
  ...
  {
    MapThrowException.ThrowNullPointerException(southwest, "null southwest");
    
    MapThrowException.ThrowNullPointerException(northeast, "null northeast");
    
    MapThrowException.ThrowIllegalArgumentException(northeast.latitude >= southwest.latitude, "southern latitude exceeds northern latitude (%s > %s)", new Object[]{
...
//      return (this.c <= paramDouble) || (paramDouble <= this.d);
    ...
    {
      MapThrowException.ThrowIllegalStateException(
