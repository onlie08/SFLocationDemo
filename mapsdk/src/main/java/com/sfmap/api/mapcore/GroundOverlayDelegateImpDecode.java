  ...
  implements IGroundOverlayDelegateDecode
{
  ...
  public void setDimensions(float paramFloat)
    throws RemoteException
  {
    MapThrowException.bThrowIllegalArgumentException(paramFloat >= 0.0F, "Width must be non-negative");
  ...
  public void setDimensions(float paramFloat1, float paramFloat2)
    throws RemoteException
  {
    MapThrowException.bThrowIllegalArgumentException(paramFloat1 >= 0.0F, "Width must be non-negative");
    
    MapThrowException.bThrowIllegalArgumentException(paramFloat2 >= 0.0F, "Height must be non-negative");
  ...
  public void setTransparency(float paramFloat)
    throws RemoteException
  {
    MapThrowException.bThrowIllegalArgumentException((paramFloat >= 0.0F) && (paramFloat <= 1.0F), "Transparency must be in the range [0..1]");
