...
import com.sfmap.api.services.route.RouteSearch.WalkRouteQuery;
...
class WalkSearchServerHandler extends
	...
	protected String getUrl() {
		String url = null;
		url = AppInfo.getSearchDetailUrl(this.context) + "?";
		return url;
	}
	...
	@Override
	protected WalkRouteResult parseJson(JSONObject obj) throws SearchException {
